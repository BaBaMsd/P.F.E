# Generated by Django 4.1.7 on 2023-05-24 18:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nom', models.CharField(max_length=50)),
                ('categorie', models.CharField(choices=[('enfants', 'Enfants'), ('jeunes-femmes', 'Jeunes-Femmes'), ('jeunes-hommes', 'Jeunes-Hommes'), ('veux', 'Veux'), ('tout-monde', 'Tout-Monde')], max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Wilaya',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doses', models.ManyToManyField(to='utulisateurs.vaccin_dose')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='utulisateurs.patient')),
